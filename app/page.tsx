        ...
        <section className="bg-[#011520] text-white py-16 md:py-20 px-6 rounded-[2.5rem]">
          <div className="max-w-[1400px] mx-auto grid md:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-16">
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li>
                  <a href="https://www.linkedin.com/in/zamar-masood-06b1942b3/" className="text-gray-400 hover:text-white transition-colors duration-300">
                    LinkedIn
                  </a>
                </li>
                <li>
                  <a href="https://github.com/zamarmasood4" className="text-gray-400 hover:text-white transition-colors duration-300">
                    GitHub
                  </a>
                </li>
                <li>
                  <a href="mailto:zamarmasood4@gmail.com" className="text-gray-400 hover:text-white transition-colors duration-300">
                    Email
                  </a>
                </li>
              </ul>
